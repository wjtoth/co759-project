...
%A more ambitious approach would be trying to replicate what \cite{fischetti2017deep} did for Neural Networks with ReLUs as activation functions. A hard threshold could be easily modeled in an Integer Program.