...
class TPRule(Enum):
    ...
    @staticmethod
    def tanh_backward(step_input, grad_output, target, is01, xscale=1.0, 
                      yscale=1.0, tanh_factor=1.0, include_target=False, velocity=None, 
                      momentum_factor=0, return_target=False):
        assert not is01
        ...
        if include_target:
            ...
            z = torch.tanh(step_input*tanh_factor)
